...
/*
 * This file was taken from the tritonus project to avoid a dependency on the library
 */
/*
 * conversion tool taken from tritonus (http://www.tritonus.org)
 */

/*
 *      ConversionTool.java - (originally) TConversionTool.java
 */ 
